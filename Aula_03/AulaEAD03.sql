...
values('Pedro Assis','97999-9898',20131126);

insert into tbalunos(nome,fone,nascimento)
values('Jose Assis','98888-5555',20151126);

insert into tbalunos(nome,fone,nascimento)
values('Mateus','97999-2020',20180520);

insert into tbalunos(nome,fone,nascimento)
values('Leandro Ramos','98888-5555',now());
